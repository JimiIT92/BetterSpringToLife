...
public class HollowBlock extends PillarBlock implements Waterloggable {
    ...
    private static final Supplier<Map<Block, Block>> HOLLOWABLES = Suppliers.memoize(() -> ImmutableMap.<Block, Block>builder()
            .put(Blocks.OAK_LOG, BSDBlocks.HOLLOW_OAK_LOG)
            .put(Blocks.STRIPPED_OAK_LOG, BSDBlocks.HOLLOW_STRIPPED_OAK_LOG)
            .put(BSDBlocks.HOLLOW_OAK_LOG, BSDBlocks.HOLLOW_STRIPPED_OAK_LOG)
            .put(Blocks.SPRUCE_LOG, BSDBlocks.HOLLOW_SPRUCE_LOG)
            .put(Blocks.STRIPPED_SPRUCE_LOG, BSDBlocks.HOLLOW_STRIPPED_SPRUCE_LOG)
            .put(BSDBlocks.HOLLOW_SPRUCE_LOG, BSDBlocks.HOLLOW_STRIPPED_SPRUCE_LOG)
            .put(Blocks.BIRCH_LOG, BSDBlocks.HOLLOW_BIRCH_LOG)
            .put(Blocks.STRIPPED_BIRCH_LOG, BSDBlocks.HOLLOW_STRIPPED_BIRCH_LOG)
            .put(BSDBlocks.HOLLOW_BIRCH_LOG, BSDBlocks.HOLLOW_STRIPPED_BIRCH_LOG)
            .put(Blocks.JUNGLE_LOG, BSDBlocks.HOLLOW_JUNGLE_LOG)
            .put(Blocks.STRIPPED_JUNGLE_LOG, BSDBlocks.HOLLOW_STRIPPED_JUNGLE_LOG)
            .put(BSDBlocks.HOLLOW_JUNGLE_LOG, BSDBlocks.HOLLOW_STRIPPED_JUNGLE_LOG)
            .put(Blocks.ACACIA_LOG, BSDBlocks.HOLLOW_ACACIA_LOG)
            .put(Blocks.STRIPPED_ACACIA_LOG, BSDBlocks.HOLLOW_STRIPPED_ACACIA_LOG)
            .put(BSDBlocks.HOLLOW_ACACIA_LOG, BSDBlocks.HOLLOW_STRIPPED_ACACIA_LOG)
            .put(Blocks.DARK_OAK_LOG, BSDBlocks.HOLLOW_DARK_OAK_LOG)
            .put(Blocks.STRIPPED_DARK_OAK_LOG, BSDBlocks.HOLLOW_STRIPPED_DARK_OAK_LOG)
            .put(BSDBlocks.HOLLOW_DARK_OAK_LOG, BSDBlocks.HOLLOW_STRIPPED_DARK_OAK_LOG)
            .put(Blocks.MANGROVE_LOG, BSDBlocks.HOLLOW_MANGROVE_LOG)
            .put(Blocks.STRIPPED_MANGROVE_LOG, BSDBlocks.HOLLOW_STRIPPED_MANGROVE_LOG)
            .put(BSDBlocks.HOLLOW_MANGROVE_LOG, BSDBlocks.HOLLOW_STRIPPED_MANGROVE_LOG)
            .put(Blocks.BAMBOO_BLOCK, BSDBlocks.HOLLOW_BAMBOO_BLOCK)
            .put(Blocks.STRIPPED_BAMBOO_BLOCK, BSDBlocks.HOLLOW_STRIPPED_BAMBOO_BLOCK)
            .put(BSDBlocks.HOLLOW_BAMBOO_BLOCK, BSDBlocks.HOLLOW_STRIPPED_BAMBOO_BLOCK)
            .put(Blocks.CHERRY_LOG, BSDBlocks.HOLLOW_CHERRY_LOG)
            .put(Blocks.STRIPPED_CHERRY_LOG, BSDBlocks.HOLLOW_STRIPPED_CHERRY_LOG)
            .put(BSDBlocks.HOLLOW_CHERRY_LOG, BSDBlocks.HOLLOW_STRIPPED_CHERRY_LOG)
            .put(Blocks.PALE_OAK_LOG, BSDBlocks.HOLLOW_PALE_OAK_LOG)
            .put(Blocks.STRIPPED_PALE_OAK_LOG, BSDBlocks.HOLLOW_STRIPPED_PALE_OAK_LOG)
            .put(BSDBlocks.HOLLOW_PALE_OAK_LOG, BSDBlocks.HOLLOW_STRIPPED_PALE_OAK_LOG)
            .put(Blocks.CRIMSON_STEM, BSDBlocks.HOLLOW_CRIMSON_STEM)
            .put(Blocks.STRIPPED_CRIMSON_STEM, BSDBlocks.HOLLOW_STRIPPED_CRIMSON_STEM)
            .put(BSDBlocks.HOLLOW_CRIMSON_STEM, BSDBlocks.HOLLOW_STRIPPED_CRIMSON_STEM)
            .put(Blocks.WARPED_STEM, BSDBlocks.HOLLOW_WARPED_STEM)
            .put(Blocks.STRIPPED_WARPED_STEM, BSDBlocks.HOLLOW_STRIPPED_WARPED_STEM)
            .put(BSDBlocks.HOLLOW_WARPED_STEM, BSDBlocks.HOLLOW_STRIPPED_WARPED_STEM)
        .build());
