 ...
 */
public final class TallSnowyGrassBlock extends SnowyVegetationBlock implements Fertilizable {
    ...
    public boolean isFertilizable(final WorldView world, final BlockPos pos, final BlockState state) {
        return Fertilizable.canSpread(world, pos, BSTLBlocks.SHORT_SNOWY_GRASS.getDefaultState());
    }
    ...
    public void grow(final ServerWorld world, final Random random, final BlockPos pos, final BlockState state) {
        Fertilizable.findPosToSpreadTo(world, pos, BSTLBlocks.SHORT_SNOWY_GRASS.getDefaultState()).ifPresent((blockPos) -> world.setBlockState(blockPos, BSTLBlocks.SHORT_SNOWY_GRASS.getDefaultState()));
    }
