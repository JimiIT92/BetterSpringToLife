 ...
 */
public final class LeafPileBlock extends SnowBlock implements Waterloggable {
    ...
    protected boolean canPlaceAt(final BlockState state, final WorldView world, final BlockPos pos) {
        ...
        if (blockState.isIn(BSTLTags.BlockTags.LEAF_PILE_CANNOT_SURVIVE_ON)) {
            return false;
        } else if (blockState.isIn(BSTLTags.BlockTags.LEAF_PILE_CAN_SURVIVE_ON)) {
            return true;
        } else {
