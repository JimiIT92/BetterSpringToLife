...
public class ShortSnowyGrassBlock extends SnowyVegetationBlock implements BonemealableBlock {

    public ShortSnowyGrassBlock(Properties properties) {
        super(properties);
    }

    @Override
    protected VoxelShape getShape(BlockState state, BlockGetter level, BlockPos pos, CollisionContext context) {
        return Block.column(12, 0, 10);
    }
