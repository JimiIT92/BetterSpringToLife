 ...
 */
public final class MuddyPigEntity extends PigEntity implements Shearable {
    ...
    public @Nullable PigEntity createChild(final ServerWorld world, final PassiveEntity entity) {
        final MuddyPigEntity child = BSTLEntities.MUDDY_PIG.create(world, SpawnReason.BREEDING);
        if(child != null) {
